...
def re_ranking(q_g_dist, q_q_dist, g_g_dist, k1=20, k2=6, lambda_value=0):
...
def com_re_ranking(q_g_dist, q_q_dist, g_g_dist,rank_list, k1=20, k2=6, lambda_value=0):
    # The following naming, e.g. gallery_num, is different from outer scope.
    # Don't care about it.
    original_dist = np.concatenate(
        [np.concatenate([q_q_dist, q_g_dist], axis=1),
